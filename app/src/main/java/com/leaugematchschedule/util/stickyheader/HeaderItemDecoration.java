package com.leaugematchschedule.util.stickyheader;
...
public class HeaderItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        if (headerView == null) {
            ...
            header = headerView.findViewById(R.id.row_section_header_tvHeader);
    ...
    private View inflateHeaderView(RecyclerView parent) {
        return LayoutInflater.from(parent.getContext()).inflate(R.layout.row_section_header, parent, false);
    }
